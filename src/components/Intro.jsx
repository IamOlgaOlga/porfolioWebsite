    ...
    return (
           <div class="flex justify-evenly pt-20 pb-6">
                ...
                <div class="place-self-start">
                    ...
                    <p className="text-base md:text-xl mb-3 font-medium">Software Developer, <div class="pin"></div> Dubai, UAE</p>
                    <p className="text-sm md:text-sm mb-6 font-bold">Software Developer with 7+ years of experience in international IT companies. Here is my{' '}
